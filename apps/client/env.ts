const env = {
    ...
    NEXT_PUBLIC_AUTH0_DOMAIN: process.env.NEXT_PUBLIC_AUTH0_DOMAIN || 'maybe.eu.auth0.com',
    NEXT_PUBLIC_AUTH0_CLIENT_ID:
        process.env.NEXT_PUBLIC_AUTH0_CLIENT_ID || 'NJluY2ojXJZsSEoM6ssYY5yWdZgn5rNi',
